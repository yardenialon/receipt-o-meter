        ...
        <Auth
          ...
          appearance={{
            ...
            className: {
              ...
              button: 'relative overflow-hidden font-medium transition-all duration-300 hover:shadow-lg active:scale-[0.98] min-h-[44px]',
              label: 'font-medium text-gray-700',
              input: 'transition-all duration-200 bg-white/80 backdrop-blur-sm focus:bg-white min-h-[44px]',
