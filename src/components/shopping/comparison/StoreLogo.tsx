...
export const StoreLogo = ({ storeName, className, logoUrl }: StoreLogoProps) => {
  ...
  const getLogo = (name: string) => {
    ...
    if (normalizedName.includes('נתיב החסד') || normalizedName.includes('netiv hachesed')) {
      return '/lovable-uploads/54bafbd7-1daa-4110-a3bd-1527e9232d59.png';
    }

    if (normalizedName.includes('קינג סטור') || normalizedName.includes('king store')) {
      return '/lovable-uploads/64d43793-1177-4161-b77d-8a9d178342cc.png';
    }

    if (normalizedName.includes('משנת יוסף') || normalizedName.includes('mishnat yosef')) {
      return '/lovable-uploads/7fab5270-86ce-4833-a600-de896912c2c9.png';
    }

    if (normalizedName.includes('זול ובגדול') || normalizedName.includes('zol vegadol')) {
      return '/lovable-uploads/ba3176e3-1b3b-4ebe-b0bd-a933bbfe3a91.png';
    }
